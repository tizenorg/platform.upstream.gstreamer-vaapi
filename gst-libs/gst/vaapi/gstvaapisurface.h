...
#define GST_VAAPI_BUFFER_SHARING_CAPS_NAME "video/x-vaapi-sharing"

#define GST_VAAPI_BUFFER_SHARING_CAPS           \
    GST_VAAPI_BUFFER_SHARING_CAPS_NAME ", "     \
    "type = vaapi, "                            \
    "width  = (int) [ 1, MAX ], "               \
    "height = (int) [ 1, MAX ], "               \
    "framerate = (fraction) [ 0, MAX ]"
...
struct _GstVaapiSurfaceClass {
    ...
    gboolean  (*create)(GstVaapiSurface *surface);
};
